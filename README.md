...
☐ Flights should include: flight number, origin, destination, schedule, aircraft type, seat capacity. 
...
☒ Use Handlebars for rendering pages (search results, reservation details, booking form). 
